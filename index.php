    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/recortado_polo.png" alt="slider1">
                <div class="carousel-caption">
                    polos
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/recortado_polera.png" alt="slider2">
                <div class="carousel-caption">
                    poleras
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/recortado_camisa.png" alt="slider3">
                <div class="carousel-caption">
                    y más ...
                </div>
            </div>
    ...
    <section id="new-prod-index">    
         <div class="container">
            <div class="page-header">
                <h1>Últimas <small>Novedades</small></h1>
            </div>
            <div class="row">
              	<?php
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">JOY</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/tv.jpg" alt="tienda-TV" class="img-responsive" style="width: 100%; display: block; margin: 0 auto; ">
                </div>
            </div>
        </div>
    </section>
